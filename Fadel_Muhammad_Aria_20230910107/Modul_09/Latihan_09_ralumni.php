...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td>
                <a class='btn btn-warning' href='Latihan_09_index.php?menu=ualumni&id=".$row["id"]."'>Edit</a> | <a class='btn btn-danger' href='Latihan_09_dalumni.php?id=".$row["id"]."'>Hapus</a></td></tr>";
    }
    echo "</table>";
} else {
    echo "Tidak ada data";
